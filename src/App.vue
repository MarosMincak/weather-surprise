...
export default {
  ...
  data() {
    return {
      api_key: "f1494941ec931a63e02dfd1c8ef78509",
  ...
  methods: {
    ...
    increment () {
      ...
      if(this.count == 10)
        alert('Dobra správa je, že si našla tlačidlo :).\n'
...
#app.warm{
  background-image: url(./assets/warm-bh.jpg);
}
...
.weather-box .temp {
  ...
  box-shadow: 3px 6px 0px rgba(0, 0, 0, 0.25);
}
